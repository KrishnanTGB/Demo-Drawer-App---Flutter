...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        ...
        child: new ListView(
          children: <Widget>[
            new UserAccountsDrawerHeader(
              ...
              accountEmail: new Text("krish003@gmail.com"),
              accountName: new Text("Krishnan T.G.B."),
      ...
      body: new Center(
        child: new Text("Add Your Details", style: new TextStyle(fontSize: 35.0)),
      )
    );
  }
}